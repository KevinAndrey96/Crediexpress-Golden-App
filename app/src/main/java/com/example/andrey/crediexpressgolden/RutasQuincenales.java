...
public class RutasQuincenales extends Activity {
    private String Palabra = "";
    JSONParser jParser = new JSONParser();
    static Config C=new Config();
    private String Clien = "";
    ArrayList<HashMap<String, String>> empresaList;
    private static String PALABRA_URL = C.URL+"rutasquincenales.php";
    ...
    //private static final String TAG_DCLIENTE ="Nombres";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ind=getIntent().getExtras().getString("Indic");
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            switch (items[item]) {
                                ...
                                case "Agregar/Editar ubicación": {
                                    Intent intent = new Intent(RutasQuincenales.this, Ubicacion.class);
    ...
    public void realizado() {
        ...
        {
            Toast.makeText(RutasQuincenales.this, "No ha seleccionado ninguna ruta", Toast.LENGTH_SHORT).show();
        }
        else
        {
            //new CLASEENVIAR().execute();
            Intent i = new Intent(RutasQuincenales.this,Pago.class);
    ...
    public void ubico() {
        ...
        else
        {
            ...
            {
                Toast.makeText(RutasQuincenales.this, "No hay coordenadas disponibles en esta ruta. por favor contacte un administrador", Toast.LENGTH_SHORT).show();
            }
            else {
    ...
    class Consulta extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RutasQuincenales.this);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < products.length(); i++) {
                        ...
                        String defi = c.getString(TAG_DEFINICION);
                        String cara = c.getString(TAG_CATEGORIA);*/
                        ...
                        map.put(TAG_DEFINICION, defi);
                        map.put(TAG_CATEGORIA, cara);
*/
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            RutasQuincenales.this,
                            empresaList,
                            //R.layout.activity_singlepostrutas,
...
/*
                            ...
                            new int[]{
                                    ...
                                    /*R.id.single_post_tv_Palabra,
                                    R.id.single_post_tv_definicion,
...
//                                    R.id.SPEstado,
                    ...
                    lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            IDE = iddelproducto;
                            //String telefono = (String) map.get("ID");
                            //IDE=iddelproducto.substring(4,5);
                            //Toast.makeText(Rutas.this, ""+IDE, Toast.LENGTH_SHORT).show();
    ...
    class CLASEMOROSO extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (file_url != null) {
                Toast.makeText(RutasQuincenales.this, file_url, Toast.LENGTH_LONG).show();
            }
        }
    }
