...
public class RutasMensuales extends Activity {
    ...
    private static String PALABRA_URL = C.URL+"rutasmensuales.php";
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            switch (items[item]) {
                                ...
                                case "Agregar/Editar ubicación": {
                                    Intent intent = new Intent(RutasMensuales.this, Ubicacion.class);
    ...
    public void realizado() {
        ...
        {
            Toast.makeText(RutasMensuales.this, "No ha seleccionado ninguna ruta", Toast.LENGTH_SHORT).show();
        }
        else
        {

            Intent i = new Intent(RutasMensuales.this,Pago.class);
    ...
    public void ubico() {
        ...
        else
        {
            ...
            {
                Toast.makeText(RutasMensuales.this, "No hay coordenadas disponibles en esta ruta. por favor contacte un administrador", Toast.LENGTH_SHORT).show();
            }
            else {
    ...
    class Consulta extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RutasMensuales.this);
    ...
    class CLASEMOROSO extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (file_url != null) {
                Toast.makeText(RutasMensuales.this, file_url, Toast.LENGTH_LONG).show();
            }
        }
    }
